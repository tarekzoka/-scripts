...
 
	...
	wget -O /var/volatile/tmp/script-1.0.tar.gz "https://raw.githubusercontent.com/emilnabil/scripts/main/script-1.0.tar.gz"	   
	wait	   
	tar xzvpf /tmp/*.tar.gz  -C /	   
	wait	   
	rm -r /var/volatile/tmp/script-1.0.tar.gz                         	   
